...
public class MongoMotionFrameStoreIT {
    ...
    void roundtrip_preservesNestedMotionFrame() {
        ...
        assertEquals("2026-05-22T10:00:00Z", out.getMotionFrame().getTimeWindow().getWindowStart());
        assertEquals("2026-05-22T10:05:00Z", out.getMotionFrame().getTimeWindow().getWindowEnd());
